{
    ...
    "asset.url": "http://your-url/nitro-assets",
    "c.images.url": "http://your-url/ms-swf/c_images",
    "thumbnails.url": "http://your-url/ms-swf/c_images/camera/thumbnails/%thumbnail%.png",
    ...
    "avatar.asset.url": "%asset.url%/figure/%libname%/%libname%.json",
    "avatar.asset.effect.url": "%asset.url%/effect/%libname%/%libname%.json",
    "navigator.slider.enabled": true,
    "navigator.slider.content": [
        {
            "title": "Nitro TESTING 1",
            "image": "https://cdn.discordapp.com/attachments/736997077124513982/798902170568228894/unknown.png",
            "roomId": 201
        },
        {
            "title": "NITRO TESTING 2",
            "image": "https://cdn.discordapp.com/attachments/736997077124513982/798902336301826108/unknown.png",
            "roomId": 202
        },
        {
            "title": "NITRO TESTING 3",
            "image": "https://cdn.discordapp.com/attachments/736997077124513982/798902523347730432/unknown.png",
            "roomId": 203
        }
    ],
    "system.fps": 24,
    ...
    "pet.asset.url": "%asset.url%/pet/%libname%/%libname%.json",
    "pet.types": [
        "dog",
        "cat",
        "croco",
    ...
    "furni.asset.url": "%asset.url%/furniture/%libname%/%libname%.json",
    "furni.asset.icon.url": "%asset.url%/icons/%libname%%param%_icon.png",
    "room.asset.url": "%asset.url%/room/%libname%/%libname%.json",
    "badge.asset.url": "%asset.url%/badges/%badgename%.gif",
    "badge.asset.group.url": "%asset.url%/group-badge/%badgedata%",
    "currency.asset.icon.url": "%images.url%/currencies/%type%.png",
    "catalog.asset.url": "%c.images.url%/catalogue",
